...
const styles = StyleSheet.create({
  heroCard: { height: 450, borderRadius: 24, overflow: 'hidden', marginBottom: 14, backgroundColor: '#DCE5FB' },
  ...
  metricGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginBottom: 14 },
